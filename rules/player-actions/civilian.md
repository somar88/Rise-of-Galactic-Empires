...
- Perform one of the following actions:
    ...
    2. Build Space ship(s):
        - Build one space ship at one [Star dock](../../pieces/space/star-dock.md) paying its cost
            1. Assign the new space ship to a fleet at its [Star System](../../pieces/space/star-system.md) or any neighbouring [Star System](../../pieces/space/star-system.md)
            2. If no fleet available: either create a new fleet if the ship is a flagship, 
            or add the ship to any one planet card available in that star system that you control
    3. Build building:
    ...
    4. Launch a [Star dock](../../pieces/space/star-dock.md):
