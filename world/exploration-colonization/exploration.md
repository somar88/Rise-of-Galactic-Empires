- Exploration:
    ...
    - The galactic map is layered in advance depending on the number of players.
    - Each star system which is not explored yes is empty and only when it is explored the planet and moon tiles 
    are added according the exploration dice, see below.
    - Exploration can be done by scouts and starships with scouting capabilities only.
...
(exploring away from the center of the galaxy should cost more moves)
    - Entering a the star system inner side always costs one movement step
